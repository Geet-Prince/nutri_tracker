    ...
    if option == "Log Food":
        ...
        if st.button('Show Results'):
            ...
            if bmi < 18.5:
                ...
                st.markdown("- **Breakfast:** Aloo paratha with curd, and a smoothie made with banana, oats, and nuts.")
                st.markdown("- **Lunch:** Chole (chickpea curry) with brown rice, and a side of mixed vegetable curry.")
                st.markdown("- **Dinner:** Paneer butter masala with whole wheat roti, and a side of sautéed spinach.")
                st.markdown("- **Snacks:** Mixed nuts, fruit chaat, or a whole wheat sandwich with paneer.")
                ...
                st.markdown("- Bananas, mangoes, avocados, and dates.")
                 ...
                 st.markdown("**Recommended Dishes:**")
                 st.markdown("- **Breakfast:** Poha with vegetables, and a cup of tea or coffee.")
                 st.markdown("- **Lunch:** Roti with dal (lentils), a mixed vegetable curry, and a side salad.")
                 st.markdown("- **Dinner:** Grilled fish or tofu tikka with a side of quinoa and steamed vegetables.")
                 st.markdown("- **Snacks:** Fresh fruit, roasted chana, or a small serving of bhel puri.")
                 ...
                 st.markdown("**Recommended Dishes:**")
                 st.markdown("- **Breakfast:** Moong dal chilla with a side of cucumber raita.")
                 st.markdown("- **Lunch:** Whole grain roti with a mixed vegetable stir-fry and a bowl of low-fat curd.")
                 st.markdown("- **Dinner:** Grilled chicken tikka or chole with a side of sautéed greens.")
                 st.markdown("- **Snacks:** Vegetable sticks with homemade hummus or a piece of fruit.")
                ...
                st.markdown("**Recommended Dishes:**")
                st.markdown("- **Breakfast:** Green smoothie with spinach, cucumber, and a small portion of fruit.")
                st.markdown("- **Lunch:** Mixed vegetable soup with a side of whole grain roti.")
                st.markdown("- **Dinner:** Baked fish or tofu with a large serving of steamed vegetables and a side salad.")
                st.markdown("- **Snacks:** Fresh fruit or a small portion of roasted nuts.")
